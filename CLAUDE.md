...
- Project structure is documented in both README.md and CONTRIBUTING.md; keep both in sync when moving files (both are already slightly stale: `agents/workers/coding_worker.py` and `agents/base_modules/` are undocumented)
